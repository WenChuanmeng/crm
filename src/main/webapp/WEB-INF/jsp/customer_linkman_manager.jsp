...
$(function() {
	...
	$.post("${ctx}/customerLinkMan/findCustomerById.action",
	...
	/*展示数据的datagrid表格*/
	$("#datagrid").edatagrid({
		url:'${ctx}/customerLinkMan/findAll.action?customerId=${param.customerId}',//只查询已分配的咨询师
		saveUrl:'${ctx}/customerLinkMan/add.action?customerId=${param.customerId}',//添加
		updateUrl:'${ctx}/customerLinkMan/update.action?customerId=${param.customerId}',//更新
		destroyUrl:'${ctx}/customerLinkMan/deleteById.action',//删除
		method:'get',
		fit:true,
		singleSelect:false,
		toolbar:'#toolbar',
		...
		columns:[[    
		     ...
		     /* {field:'customerId',title:'所属客户',width:100,align:'center',editor:{type:'validatebox',options:{required:true}}}, */    
