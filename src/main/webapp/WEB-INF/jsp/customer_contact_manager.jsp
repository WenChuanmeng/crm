...
$(function() {
	...
	$.post("${ctx}/customerContact/findCustomerById.action",
	...
	/*展示数据的datagrid表格*/
	$("#datagrid").edatagrid({
		url:'${ctx}/customerContact/findAll.action?customerId=${param.customerId}',//只查询已分配的咨询师
		saveUrl:'${ctx}/customerContact/add.action?customerId=${param.customerId}',//添加
		updateUrl:'${ctx}/customerContact/update.action?customerId=${param.customerId}',//更新
		destroyUrl:'${ctx}/customerContact/deleteById.action',//删除
		method:'get',
		fit:true,
		singleSelect:false,
		toolbar:'#toolbar',
		...
		columns:[[    
		     ...
		     {field:'address',title:'交往地点',width:100,align:'center',editor:{type:'validatebox',options:{required:true}}},    
		     {field:'overview',title:'概要',width:100,align:'center',editor:{type:'validatebox',options:{required:true}}},    
		]]  
	});
})
/* 打开新的标签页 */
