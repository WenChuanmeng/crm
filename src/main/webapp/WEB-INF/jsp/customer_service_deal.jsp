...
function openNewTab(url,icons) {
	...
	$(function(){
		...
		/*展示数据的datagrid表格*/
		$("#datagrid").datagrid({
			url:'${ctx}/customerServiceDeal/findAll.action',
			method:'get',
			fit:true,
			singleSelect:false,
			toolbar:'#toolbar',
	...
	function doSave() {
		$('#form').form('submit', {    
		    url:"${ctx}/customerServiceDeal/update.action",    
		    onSubmit: function(){    
		        // do some check    
...
<body>
	...
	<div id="toolbar">
		<div> 
			 <a class="easyui-linkbutton" href="javascript:openUpdateDialog()" iconCls="icon-edit">处理</a>
