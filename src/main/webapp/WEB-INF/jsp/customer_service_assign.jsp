...
function openNewTab(url,icons) {
	...
	$(function(){
		...
		/*展示数据的datagrid表格*/
		$("#datagrid").datagrid({
			url:'${ctx}/customerServiceAssign/findAll.action',
			method:'get',
			fit:true,
			singleSelect:false,
			toolbar:'#toolbar',
	...
	function doSave() {
		$('#form').form('submit', {    
		    url:"${ctx}/customerServiceCreate/update.action",    
		    onSubmit: function(){    
		        // do some check    
		...
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
				...
				<tr>
					...
					<td>分配时间：</td>
					<td><input type="text" id="assignTimeId" name="assignTime" class="easyui-textbox" required="true"/><font color="red">*</font></td>
				</tr>
				<!-- <tr>
					<td>开户银行：</td>
