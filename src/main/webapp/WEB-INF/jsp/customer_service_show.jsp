...
function openNewTab(url,icons) {
	...
	$(function(){
		...
		/*展示数据的datagrid表格*/
		$("#datagrid").datagrid({
			url:'${ctx}/customerServiceShow/findAll.action',
			method:'get',
			fit:true,
			singleSelect:false,
			toolbar:'#toolbar',
	...
	function doSave() {
		$('#form').form('submit', {    
		    url:"${ctx}/customerServiceShow/update.action",    
		    onSubmit: function(){    
		        // do some check    
	...
	function doSearch(){
		$("#datagrid").datagrid("load",{
			'customer':$("#s_customerId").val(),
			'overview':$("#s_overviewId").val(),
			'serviceType':$("#s_serviceTypeId").val(),
...
<body>
	...
	<div id="toolbar">
		 <div> 
			 <a class="easyui-linkbutton" href="javascript:openUpdateDialog()" iconCls="icon-edit">查看</a>
		...
		<div>
		       	客户名称：<input type="text" id="s_customerId" name="customer" style="width: 100px"/>&nbsp;&nbsp;&nbsp;
		       	概要：<input type="text" id="s_overviewId" name="overview" style="width: 100px" />&nbsp;&nbsp;&nbsp;
		       	服务类型：<select id="s_serviceTypeId" class="easyui-combobox"  name="serviceType" style="width:200px;">   
				    <option value="">--请选择--</option>   
				    <option value="咨询">咨询</option>   
				    <option value="建议">建议</option>   
				    <option value="投诉">投诉</option>   
				</select>
				创建时间：<input id="s_beginTimeId" class="easyui-datebox" name="beginTime" data-options="sharedCalendar:'#cc'">&nbsp;&nbsp;&nbsp;
				---<input id="s_endTimeId"  class="easyui-datebox" name="endTime" data-options="sharedCalendar:'#cc'">&nbsp;&nbsp;&nbsp;
		...
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
				...
				<tr>
					<td>处理结果：</td>
					<td>
						<input type="text" id="serviceDealResultId" name="serviceDealResult" readonly="readonly" class="easyui-validatebox" required="true"/><font color="red">*</font>
					</td>
					<td>服务类型 ：</td>
					<td>
						<select id="satisfyId" class="easyui-combobox"  name="satisfy" readonly="readonly" style="width:200px;">   
						     <option value="">--请选择--</option>   
						    <option value="☆☆☆☆☆">☆☆☆☆☆</option>   
						    <option value="☆☆☆☆">☆☆☆☆</option>   
						    <option value="☆☆☆">☆☆☆</option>   
