...
@Service
public class CustomerServiceDealServiceImpl implements ICustomerServiceDealService{
	@Autowired
	private CustomerServiceMapper customerServiceMapper;

	@Override
	public DataGridResult findAll(Integer page, Integer rows, CustomerService customerService) {
		...
		if (StringUtils.isNotEmpty(customerService.getLinkMan())) {
			createCriteria.andLinkManLike(Util.formatLike(customerService.getLinkMan()));
		}
		...
		createCriteria.andAssignerEqualTo(customerService.getAssigner());
		createCriteria.andServiceDealPeopleIsNull();
